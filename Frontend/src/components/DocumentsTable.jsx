...
const DocumentsTable = ({ documents, onView, onDownload, onDelete, onUpload, onEdit, onPrint }) => {
                            ...
                            <tr key={doc.id} className="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td className="px-6 py-4 no-print text-right">
                                    <div className="flex items-center justify-end gap-2">
                                        ...
                                        <button title="Print Document" onClick={() => onPrint(doc)} className="p-2 rounded-xl text-gray-600 bg-gray-50 hover:bg-gray-100 transition-all cursor-pointer shadow-sm border border-gray-200 active:scale-95"><Printer size={16} /></button>
                ...
                {documents.map((doc) => (
                    <div key={doc.id} className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:border-primary/30 transition-all relative">
                        ...
                        <div className="flex items-center justify-end gap-1 border-t border-gray-50 pt-3 mt-2 no-print">
                            ...
                            <button onClick={() => onPrint(doc)} className="p-2.5 rounded-lg text-gray-600 hover:bg-gray-50 transition-all cursor-pointer"><Printer size={15} /></button>
