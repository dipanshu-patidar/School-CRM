...
const WorkshopRow = ({ workshop, onEdit, onDelete, onView }) => {
    return (
        <>
            ...
            <tr className="hidden md:table-row hover:bg-gray-50/50 transition-colors group">
                <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-lg bg-indigo-50 flex items-center justify-center text-indigo-500 font-bold text-xs shrink-0">
                            W
                        </div>
                        <div>
                ...
                <td className="px-6 py-4">
                    <div className="flex items-center justify-end gap-1">
                        <button title="View Workshop" onClick={() => onView(workshop)} className="p-2 rounded-lg text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 transition-all cursor-pointer">
                            <Eye size={16} />
                        </button>
            ...
            {/* Mobile card */}
            <div className="md:hidden bg-white p-4 rounded-xl border border-gray-100 shadow-sm mb-3 hover:border-indigo-200 transition-all">
                <div className="flex items-start justify-between gap-2">
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                        <span className="px-2 py-0.5 rounded-full text-xs font-bold bg-indigo-50 text-indigo-700 border border-indigo-100">+1</span>
                        <button onClick={() => onView(workshop)} className="p-2 rounded-lg text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 transition-all cursor-pointer"><Eye size={15} /></button>
